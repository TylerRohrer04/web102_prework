...
const descriptionString = `$${totalPledged.toLocaleString()} has been raised for ${fundedGamesCount} ${fundedGamesCount === 1 ? 'game' : 'games'}. There ${unfundedGamesCount === 1 ? 'is' : 'are'} ${unfundedGamesCount} ${unfundedGamesCount === 1 ? 'game' : 'games'} that remain unfunded.`;
